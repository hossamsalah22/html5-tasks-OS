						...
						? (function (t, e, n) {
								return function i(o) {
									for (var s = t.querySelectorAll(e), r = o.target; r && r !== this; r = r.parentNode)
										for (var a = s.length; a--; ) if (s[a] === r) return i.oneOff && q.off(t, o.type, n), n.apply(r, [o]);
									return null;
								};
						  })(t, n, i)
						: (function (t, e) {
	...
	var et = {
		...
		lt = (function () {
			...
			return (
				...
				(e.pause = function (t) {
					t || (this._isPaused = !0),
						nt.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (p(this._element), this.cycle(!0)),
				...
				(e._slide = function (t, e) {
					...
					if (
						...
						if (
							((this._isSliding = !0), u && this.pause(), this._setActiveIndicatorElement(l), this._element.classList.contains("slide"))
						) {
	...
	q.on(document, "click.bs.collapse.data-api", '[data-toggle="collapse"]', function (t) {
		...
		nt.find(n).forEach(function (t) {
			var n,
				i = L(t, "bs.collapse");
			i
				? (null === i._parent && "string" == typeof e.parent && ((i._config.parent = e.parent), (i._parent = i._getParent())), (n = "toggle"))
				: (n = e),
		...
		wt = (function () {
			...
			return (
							...
							if (!this._inNavbar) {
								...
								"parent" === this._config.reference
									...
									: m(this._config.reference) &&
									  ((o = this._config.reference), void 0 !== this._config.reference.jquery && (o = this._config.reference[0])),
				...
				(i._getConfig = function (t) {
					return (
						(t = s(s(s({}, this.constructor.Default), et.getDataAttributes(this._element)), t)), v(_t, t, this.constructor.DefaultType), t
					);
				}),
				...
				(e.dataApiKeydownHandler = function (t) {
					if (
						...
						if ("Escape" === t.key)
							return (
								(this.matches('[data-toggle="dropdown"]') ? this : nt.prev(this, '[data-toggle="dropdown"]')[0]).focus(),
								void e.clearMenus()
							);
						if (i && "Space" !== t.key) {
			...
			return (
				...
				(e._resetScrollbar = function () {
					...
					void 0 === t
						...
						: (et.removeDataAttribute(document.body, "padding-right"), (document.body.style.paddingRight = t));
				}),
			...
			return (
					...
					if (this._isEnabled)
						if (t) {
							var e = this.constructor.DATA_KEY,
								n = L(t.target, e);
							n || ((n = new this.constructor(t.target, this._getDelegateConfig())), T(t.target, e, n)),
				...
				(i.setElementContent = function (t, e) {
					if (null !== t)
						return "object" == typeof e && m(e)
							...
							: void (this.config.html
									? (this.config.sanitize && (e = jt(e, this.config.whiteList, this.config.sanitizeFn)), (t.innerHTML = e))
									: (t.textContent = e));
				}),
				(i.getTitle = function () {
				...
				(i._getConfig = function (t) {
					...
					return (
						...
						"number" == typeof (t = s(s(s({}, this.constructor.Default), e), "object" == typeof t && t ? t : {})).delay &&
				...
				(i._fixTransition = function () {
					...
					null === t.getAttribute("x-placement") &&
						(t.classList.remove("fade"), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
				}),
				(e.jQueryInterface = function (t) {
					return this.each(function () {
			...
			(e.show = function () {
				...
				if (
					...
					if (
						...
						!(q.trigger(this._element, "show.bs.tab", { relatedTarget: e }).defaultPrevented || (null !== s && s.defaultPrevented)))
					) {
			...
			return (
				(e.show = function () {
					...
					if (!q.trigger(this._element, "show.bs.toast").defaultPrevented) {
						...
						if (
							(this._element.classList.remove("hide"), w(this._element), this._element.classList.add("showing"), this._config.animation)
						) {
				...
				(e._getConfig = function (t) {
					return (
						(t = s(s(s({}, le), et.getDataAttributes(this._element)), "object" == typeof t && t ? t : {})),
